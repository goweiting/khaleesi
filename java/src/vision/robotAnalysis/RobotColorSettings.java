...
public class RobotColorSettings {
  ...
  public static RobotType getRobotType(SDPColor team, SDPColor mainColor) {
    ...
    if (team == FRIEND_COLOR) {
      ...
      if ((mainColor == SDPColor.GREEN && FRIEND_1_IS_GREEN)
          || (mainColor == SDPColor.PINK && !FRIEND_1_IS_GREEN)) {
        builder.append('1');
      } else {
        builder.append('2');
      }
      ...
      builder.append("FOE_");
      if ((mainColor == SDPColor.GREEN && FOE_1_IS_GREEN)
          || (mainColor == SDPColor.PINK && !FOE_1_IS_GREEN)) {
        builder.append('1');
      } else {
        builder.append('2');
      }
