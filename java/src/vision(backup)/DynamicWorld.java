 ...
 *
 * <p>SDP2017NOTE This is the object that gets passed out of the Vision System to all its registered
 * listeners. Read this carefully, it is fairly important.
 */
public class DynamicWorld {
  ...
  public void printData() {
    ...
    if (this.probableBallHolder != null)
      SDPConsole.writeln("Probable ball holder: " + this.probableBallHolder.toString());
    if (this.lastKnownBall != null)
      SDPConsole.writeln("Last Known ball: " + this.lastKnownBall.toString());
  }
