 ...
 *
 * <p>SDP2017NOTE - This class contains everything you could possibly need for your mathsy
 * calculations.
 */
public class VectorGeometry {
  ...
  public static VectorGeometry closerOfTwo(
      VectorGeometry point, VectorGeometry a, VectorGeometry b) {
  ...
  public static void main(String[] args) {
    ...
    //        ));
    System.out.println(
        VectorGeometry.signedAngle(new VectorGeometry(1, 0), new VectorGeometry(0, 1)));
    System.out.println(
        VectorGeometry.signedAngle(new VectorGeometry(0, 1), new VectorGeometry(1, 0)));
  }
  ...
  public static boolean isInRectangle(
      VectorGeometry point, double x1, double y1, double x2, double y2) {
  ...
  /**
   * The barrel undistortion algorithm. Gets rid of that fish-eye thing that the camera does. Google
