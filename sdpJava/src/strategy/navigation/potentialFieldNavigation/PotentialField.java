...
public class PotentialField {
  ...
  public static PotentialField worldToPotentialField(DynamicWorld world) {
    ...
    if (friend != null
        && WorldTools.isPointInFriendDefenceArea(friend.location)
        && us != null
  ...
  public PotentialField addWalls() {
    ...
    this.addSource(
        new LineSource(
                new VectorGeometry(halfWidth, halfHeight),
                new VectorGeometry(halfWidth, -halfHeight),
                false,
                WALL_FIELD_FORMULA)
            .setSize(WALL_SIZE)
  ...
  public PotentialField addEnemyDefence() {
    ...
    this.addSource(
        new LineSource(
                new VectorGeometry(halfWidth - 30, 30),
                new VectorGeometry(halfWidth - 30, -30),
                false,
                WALL_FIELD_FORMULA)
            .setSize(WALL_SIZE + 15)
            .setYFactor(WALL_Y_FACTOR));
    return this;
  }
  ...
  public void setObstacles(LinkedList<Obstacle> obstacles) {
    for (Obstacle o : obstacles) {
      this.addSource(
          new PointSource(new VectorGeometry(o.x, o.y), false, FieldFormula.E_TO_MINUS_X)
              .setSize(30));
    }
  }
}
