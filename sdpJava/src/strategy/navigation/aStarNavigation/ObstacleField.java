...
public class ObstacleField {
  ...
  public ObstacleField addWalls() {
    ...
    int wallwidth = 30;
    this.addAStarObstacle(
        new Rectangle(
            new VectorGeometry(-halfWidth - 50, halfHeight + 50),
            new VectorGeometry(-halfWidth + wallwidth, -halfHeight - 50)));
    this.addAStarObstacle(
        new Rectangle(
            new VectorGeometry(-halfWidth - 50, halfHeight + 50),
            new VectorGeometry(halfWidth + 50, halfHeight - wallwidth)));
    this.addAStarObstacle(
        new Rectangle(
            new VectorGeometry(-halfWidth - 50, -halfHeight + wallwidth),
            new VectorGeometry(halfWidth + 50, -halfHeight - 50)));
  ...
  public ObstacleField addEnemyDefence() {
    ...
    this.addAStarObstacle(
        new Rectangle(new VectorGeometry(halfWidth - 60, 60), new VectorGeometry(halfWidth, -60)));
    return this;
  }
  ...
  public ObstacleField addFriendDefence() {
    ...
    this.addAStarObstacle(
        new Rectangle(
            new VectorGeometry(-halfWidth, 60), new VectorGeometry(-halfWidth + 60, -60)));
    return this;
  }
}
