      ...
      switch (e.getKeyChar()) {
        ...
        case '1':
          ...
          Strategy.getCurrentBehaviour()
              .setCurrentAction(new HoldPosition(new ConstantPoint(-50, -50)));
          break;
        case '2':
          Strategy.setBehaviour(new PassiveBehaviour());
          Strategy.getCurrentBehaviour()
              .setCurrentAction(new HoldPosition(new ConstantPoint(0, -50)));
          break;
        case '3':
          Strategy.setBehaviour(new PassiveBehaviour());
          Strategy.getCurrentBehaviour()
        ...
        case '4':
          Strategy.setBehaviour(new PassiveBehaviour());
          Strategy.getCurrentBehaviour()
              .setCurrentAction(new HoldPosition(new ConstantPoint(-50, 0)));
          break;
        case '5':
          Strategy.setBehaviour(new PassiveBehaviour());
          Strategy.getCurrentBehaviour()
              .setCurrentAction(new HoldPosition(new ConstantPoint(0, 0)));
          break;
        case '6':
          Strategy.setBehaviour(new PassiveBehaviour());
          Strategy.getCurrentBehaviour()
