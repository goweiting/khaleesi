 ...
 * <p>
 * SDP2017NOTE - This class contains everything you could possibly need for your mathsy
 * calculations.
 */
public class VectorGeometry {
     ...
     */
    public static VectorGeometry closestPointToLine(VectorGeometry base, VectorGeometry dir,
     ...
     */
    public static boolean isInGeneralDirection(VectorGeometry base, VectorGeometry dir,
                                               VectorGeometry point) {
     ...
     */
    public static VectorGeometry vectorToClosestPointOnFiniteLine(VectorGeometry a, VectorGeometry b,
                                                                  VectorGeometry point) {
     ...
     */
    public static VectorGeometry intersectionWithFiniteLine(VectorGeometry base, VectorGeometry dir,
                                                            VectorGeometry a, VectorGeometry b) {
    ...
    public static VectorGeometry closerOfTwo(VectorGeometry point, VectorGeometry a,
                                             VectorGeometry b) {
    ...
    public static double distanceFromLine(VectorGeometry base, VectorGeometry dir,
                                          VectorGeometry point) {
     ...
     */
    public static VectorGeometry intersectionOfLines(VectorGeometry base1, VectorGeometry dir1,
                                                     VectorGeometry base2, VectorGeometry dir2) {
...
//        ));
        System.out
                .println(VectorGeometry.signedAngle(new VectorGeometry(1, 0), new VectorGeometry(0, 1)));
        System.out
                .println(VectorGeometry.signedAngle(new VectorGeometry(0, 1), new VectorGeometry(1, 0)));
    }
    ...
    public static boolean isInRectangle(VectorGeometry point, double x1, double y1, double x2,
                                        double y2) {
    ...
    /**
     * This function superimposes a tilted coordinate system on top of the existing one and changes
     * the vector to have the X and Y coordinates of wherever it was pointing in the superimposed
     * coordinate system.
     *
    ...
    public VectorGeometry barrelUndistort(double barrelConstant) {
        ...
        double undistortedDistance =
                distortedDistance / (1 - barrelConstant * distortedDistance * distortedDistance);
